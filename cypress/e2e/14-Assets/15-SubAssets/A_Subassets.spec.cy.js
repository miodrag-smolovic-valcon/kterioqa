...
describe('Assets component check', () =>{
    ...
    it.only('Check second page', () => {
        ...
        cy.get('.o-content button').eq(0).click() //First input field
        cy.get('.c-select__option:nth-child(1)').click()
        cy.wait(2000)

        cy.get('.o-content button').eq(1).click() //First input field
        cy.get('.c-select__option:nth-child(1)').click()
        cy.wait(2000)
